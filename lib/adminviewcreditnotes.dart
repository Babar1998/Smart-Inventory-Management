...
class AdminViewCredit extends StatefulWidget {
  final String name;
  ...
  final String remain;
  const AdminViewCredit(this.name, this.quantity, this.price, this.grandTotal,
      this.remain, this.creditnid,
      {Key? key})
      : super(key: key);

  @override
  State<AdminViewCredit> createState() => _AdminViewCreditState();
}

class _AdminViewCreditState extends State<AdminViewCredit> {
        ...
        leading: IconButton(
            onPressed: () {
              Navigator.push(context,
                  MaterialPageRoute(builder: (context) => const AdminCredit()));
            },
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      Navigator.pushReplacement(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const AdminCredit(),
                        ),
                      );
                    },
                    child: const Text('OK'),
