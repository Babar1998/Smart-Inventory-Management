...
import 'package:simsfyp/custviewbill.dart';

class CustomerBill extends StatefulWidget {
  const CustomerBill({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        leading: IconButton(
          onPressed: () {
            Navigator.push(
                context, MaterialPageRoute(builder: (context) => const customerdashboard()));
          },
                              ...
                              IconButton(
                                onPressed: () {
                                  Navigator.pushReplacement(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => CustomerViewBill(name,
