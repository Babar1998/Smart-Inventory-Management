...
import 'package:simsfyp/addsalesorder.dart';

class CustSaleInventory extends StatefulWidget {
  const CustSaleInventory({Key? key}) : super(key: key);

  @override
  State<CustSaleInventory> createState() => _CustSaleInventoryState();
}

class _CustSaleInventoryState extends State<CustSaleInventory> {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        leading: IconButton(
            onPressed: () {
              Navigator.push(
                  context, MaterialPageRoute(builder: (context) => const CustomerSale()));
            },
