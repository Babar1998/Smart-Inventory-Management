...
import 'package:simsfyp/custviewsalesreturn.dart';

class CustReturn extends StatefulWidget {
  const CustReturn({Key? key}) : super(key: key);

  @override
  State<CustReturn> createState() => _CustReturnState();
}

class _CustReturnState extends State<CustReturn> {
                              ...
                              IconButton(
                                onPressed: () {
                                  Navigator.pushReplacement(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => CustViewReturn(
                                          name,
                                          quantity,
                                          price,
                                          grandtotal,
