...
import 'package:simsfyp/adminviewcreditnotes.dart';

class AdminCredit extends StatefulWidget {
  const AdminCredit({Key? key}) : super(key: key);
          ...
          Expanded(
            child: FirebaseAnimatedList(
                ...
                itemBuilder: (context, snapshot, animation, index) {
                  ...
                  final remain = snapshot.child('remaining').value.toString();
                  final creditnid =
                      snapshot.child('creditnid').value.toString();
                              ...
                              IconButton(
                                onPressed: () {
                                  Navigator.pushReplacement(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => AdminViewCredit(
                                          name,
                                          quantity,
                                          price,
                                          grandtotal,
