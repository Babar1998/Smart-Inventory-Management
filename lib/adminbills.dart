...
import 'package:simsfyp/adminviewbill.dart';

class AdminBill extends StatefulWidget {
  const AdminBill({Key? key}) : super(key: key);

  @override
  State<AdminBill> createState() => _AdminBillState();
}

class _AdminBillState extends State<AdminBill> {
                              ...
                              IconButton(
                                onPressed: () {
                                  Navigator.pushReplacement(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => AdminViewBill(name,
                                          quantity, price, grandtotal, saleid),
                                    ),
                                  );
                                },
