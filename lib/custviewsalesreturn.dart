...
class CustViewReturn extends StatefulWidget {
  final String name;
  ...
  final String reason;
  const CustViewReturn(this.name, this.quantity, this.price, this.grandTotal,
      this.reason, this.salereturnid,
      {Key? key})
      : super(key: key);

  @override
  State<CustViewReturn> createState() => _CustViewReturnState();
}

class _CustViewReturnState extends State<CustViewReturn> {
        ...
        leading: IconButton(
            onPressed: () {
              Navigator.push(context,
                  MaterialPageRoute(builder: (context) => const CustReturn()));
            },
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      Navigator.pushReplacement(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const CustReturn(),
                        ),
                      );
                    },
                    child: const Text('OK'),
